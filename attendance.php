...
<body>
    ...
    <h1 id="student-title">All Students</h1>
...
<?php
    ...
    class MyDB extends SQLite3 {
     ...
     $sql =<<<EOF
     SELECT name, is_present from Attendance;
    EOF;
    $ret = $db->query($sql);
...
<h1 id="student-title">Students who are Absent</h1>
<textarea rows="10" cols="50">
...
<?php
    ...
    class MyDBS extends SQLite3 {
     ...
     $dbs = new MyDBS();
     if(!$dbs) {
        echo $dbs->lastErrorMsg();
     } else {
        //echo "Opened database successfully\n";
     }
     $sql =<<<EOF
      
      SELECT name, is_present from Attendance A where A.is_present = "Absent" ; 
    EOF;
    $ret = $dbs->query($sql);
